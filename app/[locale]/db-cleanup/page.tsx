...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  return {
    title: `DB Cleanup | ${t.brand}`,
    description: "Clean newly collected DB rows, compare them against your existing master file, and export both the final lead list and merged cumulative DB.",
    alternates: {
    ...
    openGraph: {
      ...
      locale,
      title: `DB Cleanup | ${t.brand}`,
      description: "A workflow page for deduplicating new DB files and producing both a clean prospect file and an updated cumulative DB.",
    ...
    twitter: {
      ...
      title: `DB Cleanup | ${t.brand}`,
      description: "Remove internal duplicates, compare with your existing DB, and download both output files in one place.",
