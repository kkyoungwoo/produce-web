  ...
  return [
    {
      ...
      title: 'Qwen3-TTS',
      provider: '무료 모델',
      description: 'Google AI Studio TTS를 사용하는 기본 무료 음성 모델입니다. 한국어 대사 생성에 바로 사용할 수 있습니다.',
      badge: '무료',
      priceLabel: '무료',
      costHint: '예상 비용: 무료',
      qualityLabel: '기본형',
  ...
  const result: AiPickerOption[] = [
    {
      ...
      title: 'Qwen3-TTS 무료 모델',
      provider: 'Qwen3-TTS',
      description: 'Google AI Studio TTS를 이용하는 기본 무료 음성 모델입니다.',
      badge: '무료',
      priceLabel: '무료',
      costHint: '예상 비용: 무료',
      qualityLabel: '기본형',
