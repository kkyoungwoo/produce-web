...
export const STEP_AGENT_REGISTRY: StepAgentProfile[] = [
  {
    ...
    promptPath: '/lib/mp4Creater/prompt-center/concept/bundles.ts#story',
  ...
  },
  {
    ...
    promptPath: '/lib/mp4Creater/prompt-center/steps/layers.ts#script',
  ...
  },
  {
    ...
    promptPath: '/lib/mp4Creater/prompt-center/samples/library.ts#characters',
  ...
  },
  {
    ...
    promptPath: '/lib/mp4Creater/prompt-center/samples/library.ts#styles',
  ...
  },
  {
    ...
    promptPath: '/lib/mp4Creater/prompt-center/steps/layers.ts#style',
  ...
  },
  {
    ...
    promptPath: '/lib/mp4Creater/prompt-center/steps/layers.ts#scene',
