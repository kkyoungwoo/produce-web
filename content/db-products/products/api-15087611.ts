...
const product: ProductItem = {
  ...
  title: "등록공장 생산정보 조회",
  summary: "지역과 고용인원, 공장 등록일자 조건으로 등록공장 생산정보를 조회할 수 있습니다.",
  description:
  ...
  audience: "지역별 공장 등록 현황과 고용 규모를 빠르게 확인하려는 사용자",
  features: [
    "지역 선택 후 등록공장 생산정보를 안정적으로 조회할 수 있습니다.",
  ...
  sampleRequest: `?serviceKey=${SERVICE_KEY_SAMPLE}&type=json&pageNo=1&numOfRows=500&adres=서울특별시`,
  apiCredential: serviceKeyCredential("15087611"),
  apiRuntime: {
    endpoint: "https://apis.data.go.kr/B550624/fctryRegistInfo/getFctryPrdctnService_v2",
